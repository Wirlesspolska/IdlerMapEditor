...
#define String(key, dflt)                             \
	...
	Int(SPAWN_USE_CANONICAL_MONSTER_NAMES, 0);
	...
	Int(SPRITE_TRANSPARENCY, 0);
	Int(MINIMAP_UPDATE_DELAY, 333);
	Int(MINIMAP_VIEW_BOX, 1);
	String(MINIMAP_EXPORT_DIR, "");
	String(TILESET_EXPORT_DIR, "");
	String(MAP_JSON_EXPORT_DIR, "");
	Int(PROPOSED_BRUSH_HOTKEYS, 0);
	Int(MARKETPLACE_ENABLED, 1);
	String(MARKETPLACE_URL, "http://127.0.0.1:8787");
	String(MARKETPLACE_NICKNAME, "");
	...
	Int(TOOLTIP_SHOW_CONTAINER_CONTAINS, 0);
